...
class LocalArtworkUriTest {
    ...
    @Test
    fun parseSongIdFromVolatileArtworkUri_readsSharedProviderSongId() {
        assertThat(LocalArtworkUri.parseSongIdFromVolatileArtworkUri(
            "content://com.theveloper.pixelplay.artwork/song/99?t=1234"
        )).isEqualTo(99L)
    }

    @Test
    fun parseSongIdFromVolatileArtworkUri_rejectsMalformedSharedProviderPath() {
        assertThat(LocalArtworkUri.parseSongIdFromVolatileArtworkUri(
            "content://com.theveloper.pixelplay.artwork/song/99/other"
        )).isNull()
    }
