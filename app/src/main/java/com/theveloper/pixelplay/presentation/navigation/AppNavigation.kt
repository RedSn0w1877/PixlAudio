...
import com.theveloper.pixelplay.data.premium.PlusCheckoutConfig
...
import com.theveloper.pixelplay.presentation.screens.YourMixScreen
...
import com.theveloper.pixelplay.presentation.screens.PlusScreen
import com.theveloper.pixelplay.presentation.screens.PlusLicenseDebugScreen
...
fun AppNavigation(
    ...
    startDestination?.let { initialRoute ->
        NavHost(
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    PlusScreen(
                        ...
                        onInsightClick = { navController.navigateSafely(Screen.Stats.route) },
                        onSmartPlaylistClick = { navController.navigateSafely(Screen.Library.route) },
                        onSupportClick = { amountCents ->
                            val checkoutUrl = PlusCheckoutConfig.urlForSupportAmount(amountCents)
                            if (checkoutUrl == null) {
                                false
                            } else {
                                runCatching {
            ...
            composable(
                Screen.PlusLicenseDebug.route,
            ) {
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    PlusLicenseDebugScreen(onBackClick = { navController.popBackStack() })
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    AccountsScreen(
                        onBackClick = { navController.popBackStack() },
                        onManageSpotify = { navController.navigate(Screen.SpotifyDashboard.route) }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.theveloper.pixelplay.presentation.spotify.dashboard.SpotifyDashboardScreen(
                        onBackClick = { navController.popBackStack() },
                        onBrowseClick = { navController.navigate(Screen.SpotifyBrowse.createRoute()) },
            ...
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    com.theveloper.pixelplay.presentation.youtube.YouTubeLoginScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
            composable(
                ...
                ScreenWrapper(navController = navController, playerViewModel = playerViewModel, animatedVisibilityScope = this) {
                    ...
                    com.theveloper.pixelplay.presentation.spotify.browse.SpotifyBrowseScreen(
                        initialQuery = java.net.URLDecoder.decode(initialQuery, "UTF-8"),
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
