...
sealed class Screen(val route: String) {
    ...
    object PlusLicenseDebug : Screen("plus_license_debug")
    ...
    object YourMixScreen : Screen("your_mix")
    ...
    /** Replaces the old DJ Space two-deck mixer, which Remix Studio supersedes. */
    object RemixStudio : Screen("remix_studio")
    ...
    object SpotifyBrowse : Screen("spotify_browse?q={query}") {
        /**
         * @param query búsqueda con la que abrir el explorador. Vacío abre el inicio
         *   ("lo más escuchado"); las categorías de la pantalla de búsqueda pasan aquí
         *   su género para que los resultados salgan del catálogo en vivo.
         */
        fun createRoute(query: String = ""): String =
            "spotify_browse?q=" + java.net.URLEncoder.encode(query, "UTF-8")
    }
