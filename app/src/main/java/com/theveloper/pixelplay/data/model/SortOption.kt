...
sealed class SortOption(
    ...
    /** Drag-to-reorder position — [com.theveloper.pixelplay.data.database.PlaylistEntity.sortOrder]. */
    object PlaylistCustomOrder : SortOption(
        storageKey = "playlist_custom_order",
        displayName = "Custom Order",
        displayNameRes = R.string.sort_display_custom_order,
        methodLabel = "Custom Order",
        methodLabelRes = R.string.sort_method_custom_order,
        methodKey = "playlist_custom_order",
        direction = SortDirection.Ascending
    )
