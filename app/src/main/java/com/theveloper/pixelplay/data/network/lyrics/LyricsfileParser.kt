...
internal object LyricsfileParser {
    fun parse(raw: String?): Lyrics? {
        ...
        // Release builds may encounter a linkage/initializer failure from the optional
        // SnakeYAML dependency. Lyrics-file parsing is only one catalog candidate, so
        // never allow that failure to take down playback or the rest of the lyric chain.
